...
export default function IncomeMonthEditor({ userId, month, year, current, prevIncome }: Props) {
  ...
  // El total es SIEMPRE lo que el usuario escribe — los ítems son solo informativos
  ...
  // Estado "calza": ítems existen, todos tienen valor, y suman exacto al total
  ...
  return (
    <div className="space-y-5">
      ...
      >
        ...
        {items.length > 0 && (
          <div className="space-y-2 mb-3">
            ...
            {/* Subtotal de ítems si hay más de uno */}
            {validItems.length > 1 && (
              <div
      ...
      {error && (
        <p className="text-sm font-medium" style={{ color: 'var(--coral)' }}>{error}</p>
      )}
